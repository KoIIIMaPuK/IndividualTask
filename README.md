...
## Описание версии
Проект реализован. Спустя несколько недель перешел в версию 1.0.0, что означает, что основная суть индивидуального задания была выполнена. 

**Мой вариант содержит следующее задание:**
- **Отчет:** Построить список клиентов, использовавших услуги двух наименований в указанный временной промежуток (с ... по ...).
- **Параметры:** Наименования двух услуг, дата начала диапазона, дата конца диапазона.

**Важно:** Моя программа может обрабатывать больше двух услуг.

## Нововведения
- Добавлен файл `Param.ini` для хранения параметров.
- Реализована функция для чтения файла `Param.ini`.
- Реализована функция для поиска клиентов и их сортировки по услуге и дате использования услуги.
