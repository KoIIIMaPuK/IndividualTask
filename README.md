# v0.23.3 — 03.12.2024
## Нововведения
- Сделал поиск в файлах по польшинству параметров;
- Изменил ввод переменных, исправил баги интерфейса, которые были с начала проекта;
    - Сущетсоввали из-за копирования с одного файла почти техже функций. в другой.
- Сильно приблизился к завершению индивидульаного задания

## Планируется
- Создать парочку функций для поиска оставшихся параметров;
- Добавить цикл для поиска нужных людей;
- По возможности оптимизировать код;
